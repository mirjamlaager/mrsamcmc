...
If a patient was never tested positive, this day is set to 20000. The dataset also
contains a column for the types of the patients. This column is ignored in the
simplest form of the model (\code{run_mcmc()}), which does not infer sources of infection.
